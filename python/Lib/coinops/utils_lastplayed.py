...
def launch_retrofe():    
    ...
    if os.path.isfile(RETRO_FE):
        ...
        monitor_all      = threading.Thread(target=refresh_favorites, args=('./collections/ArcadeAll/playlists/lastplayed.txt',
                                                                            './autochanger/favorites.png',
                                                                            './collections/ArcadeFavs/ArcadeAll.sub',
                                                                            './collections/ArcadeAll/medium_artwork/hearts'))
              
        monitor_micro    = threading.Thread(target=refresh_favorites, args=('./collections/ArcadeMicroAll/playlists/lastplayed.txt',
        ...
        monitor_backroom = threading.Thread(target=refresh_favorites, args=('./collections/Backroom/playlists/lastplayed.txt',
